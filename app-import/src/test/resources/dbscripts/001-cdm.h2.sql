...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_CONTINENT ADD CONSTRAINT PUBLIC.CONSTRAINT_BAC PRIMARY KEY(COUNTRY_ID, CONTINENTS_ID);
...
ALTER TABLE PUBLIC.DEFINEDTERMBASE_CONTINENT_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_F4 PRIMARY KEY(REV, COUNTRY_ID, CONTINENTS_ID);
...
ALTER TABLE PUBLIC.AGENTBASE_AGENTBASE ADD CONSTRAINT PUBLIC.CONSTRAINT_3 PRIMARY KEY(TEAM_ID, SORTINDEX);
...
ALTER TABLE PUBLIC.AGENTBASE_AGENTBASE_AUD ADD CONSTRAINT PUBLIC.CONSTRAINT_9 PRIMARY KEY(REV, TEAM_ID, TEAMMEMBERS_ID, SORTINDEX);
