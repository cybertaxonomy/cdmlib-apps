...
public class CaseariaIdentifierActivator {
    ...
    static final ICdmDataSource cdmDestination = CdmDestinations.cdm_local_casearia();
//    static final ICdmDataSource cdmDestination = CdmDestinations.cdm_production_casearia();
    ...
    private void doImport(ICdmDataSource cdmDestination){
        ...
        InputStreamReader source = getInputStreamFromFile();
    ...
    private InputStreamReader getInputStreamFromFile() {

//        URI.create("file:////BGBM-PESIHPC/FloraMalesianaXml/fmvol14_final2.xml")
        String path = "E://data//Casearia";
    ...
    public static void main(String[] args) {
        CaseariaIdentifierActivator me = new CaseariaIdentifierActivator();
