...
public class EuroMedCaucasusChecklistExportActivator {
    ...
    static final ICdmDataSource cubaSource = CdmDestinations.cdm_local_euromed();
    static final ICdmDataSource cdmDestination = CdmDestinations.cdm_local_georgia();
//    static final ICdmDataSource cdmDestination = CdmDestinations.cdm_local_armenia();
//    static final ICdmDataSource cubaSource = CdmDestinations.cdm_production_euromed();
...
// ***************** ALL ************************************************//
    ...
    private UUID uuidEuroMedTaxonNodeFilter = UUID.fromString("");
    ...
    private void doImport(ICdmDataSource source, ICdmDataSource destination, DbSchemaValidation hbm2dll){
        ...
        config.getTaxonNodeFilter().orSubtree(uuidEuroMedTaxonNodeFilter);
