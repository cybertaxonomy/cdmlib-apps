 ...
 * @author a.mueller
 */
public class CactaceaeIdentifierActivator {

    @SuppressWarnings("unused")
    private static final Logger logger = Logger.getLogger(CactaceaeIdentifierActivator.class);
...
//        URI.create("file:////BGBM-PESIHPC/FloraMalesianaXml/fmvol14_final2.xml")
    ...
    public static void main(String[] args) {
        CactaceaeIdentifierActivator me = new CactaceaeIdentifierActivator();
