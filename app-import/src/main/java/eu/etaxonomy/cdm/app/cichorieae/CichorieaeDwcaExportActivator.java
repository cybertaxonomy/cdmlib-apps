...
/**
 * Activator for running a Cichorieae DwC-A export for GBIF/Checklist bank.
 * Copied from eu.etaxonomy.cdm.app.dwca.DwcaExportActivator
 *
 * @author a.mueller
 */
public class CichorieaeDwcaExportActivator {
...
//	private static final ICdmDataSource cdmSource = CdmDestinations.cdm_production_cyprus();
	...
	private static final String defaultBibliographicCitation = "Kilian N., Hand R. &amp; Raab-Straube E. von (general editors) 2009+ (continuously updated): Cichorieae Systematics Portal. Published at http://cichorieae.e-taxonomy.net/portal/; " +
		"accessed ["+date+"].";
...
//		}
	...
	public static void main(String[] args) {
		CichorieaeDwcaExportActivator ex = new CichorieaeDwcaExportActivator();
