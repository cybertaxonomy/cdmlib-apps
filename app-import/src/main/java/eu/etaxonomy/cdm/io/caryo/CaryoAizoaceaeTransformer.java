 ...
 * @since 16.06.2016
 */
public class CaryoAizoaceaeTransformer extends InputTransformerBase{

    private static final long serialVersionUID = 4635704148993246218L;

    private static final Logger logger = Logger.getLogger(CaryoAizoaceaeTransformer.class);
