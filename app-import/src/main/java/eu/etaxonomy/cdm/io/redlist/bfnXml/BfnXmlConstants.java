...
public class BfnXmlConstants {
    ...
    public static final String VOC_KOMBINIERTE_LAENDER = "Kombinierte Bundesländer";
    public static final String VOC_MARINE_INVERTEBRATEN_GEBIETE = "Marine Invertebraten Gebiete";
    public static final String VOC_MARINE_ALGEN_GEBIETE = "Marine Algen Gebiete";
