 ...
 * @since 2023-08-05
 */
public class KoperskiExportState
        extends TaxonTreeExportStateBase<KoperskiExportConfigurator,KoperskiExportState>{

    private ExportResult result;

    private KoperskiExportResultProcessor processor = new KoperskiExportResultProcessor(this);
    ...
    protected KoperskiExportState(KoperskiExportConfigurator config) {
        super(config);
    ...
    protected KoperskiExportResultProcessor getProcessor() {
        return processor;
    }
