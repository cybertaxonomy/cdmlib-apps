 ...
 * @since 07.04.2025
 */
public class Erms2CdmActivator {

    @SuppressWarnings("unused")
    private static Logger logger = LogManager.getLogger();

    static final ICdmDataSource ermsSource = CdmDestinations.cdm_local_erms2();
//    static final ICdmDataSource cdmDestination = CdmDestinations.cdm_pesi_leer();
    ...
    static final String sourceRefTitle = "ERMS PESI import.";
    public static final UUID sourceRefUuid = PesiTransformer.uuidSourceRefErms;
...
//    UUID uuidTaxonNodeFilter = UUID.fromString("");
    //complete
    private static UUID uuidTaxonNodeFilter = UUID.fromString("4f854b11-b69b-4fea-bd86-2014e896546b");
...
//        config.setRecordsPerTransaction(partitionSize);
    ...
    public static void main(String[] args) {
        ...
        Erms2CdmActivator myImport = new Erms2CdmActivator();
        myImport.doImport(ermsSource, cdmDB, DbSchemaValidation.VALIDATE);
        System.exit(0);
    }
}