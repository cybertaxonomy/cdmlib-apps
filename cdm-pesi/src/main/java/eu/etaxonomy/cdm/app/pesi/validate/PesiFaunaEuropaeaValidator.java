...
//    private static final ICdmDataSource defaultSource = CdmDestinations.cdm_test_local_pesi_leer();
    private static final Source defaultDestination = PesiDestinations.pesi_test_local_CDM_FE2PESI();
//    private static final Source defaultDestination = PesiDestinations.pesi_test_local_CDM_FE2PESI_2();
    ...
    private String origFauEu  = "OriginalDB = '"+PesiTransformer.SOURCE_STR_FE+"' ";
...
//            success &= testSingleNameRelations(source.getUniqueInteger(countSynonymRelation));
    ...
    String countReferencesStr = "SELECT count(*) FROM reference r WHERE r.title IS NULL OR r.title <> 'Fauna Europaea PESI import.'";
...
//            TODO correct?
    ...
    private boolean testReferenceCount() {
        ...
        int countDest = destination.getUniqueInteger("SELECT count(*) FROM Source s WHERE s."+ origFauEu );  // +1 for the source reference "Fauna Europaea PESI import." but this has no OriginalDB
...
//** ************* MAIN ********************************************/
    ...
    public static void main(String[] args){
        PesiFaunaEuropaeaValidator validator = new PesiFaunaEuropaeaValidator();
