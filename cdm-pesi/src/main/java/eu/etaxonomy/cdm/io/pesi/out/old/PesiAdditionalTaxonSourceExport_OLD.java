 ...
 */
@Component
public class PesiAdditionalTaxonSourceExport_OLD extends PesiExportBase {

    private static final long serialVersionUID = 3495457064987643328L;
    private static final Logger logger = Logger.getLogger(PesiAdditionalTaxonSourceExport_OLD.class);
	...
	public PesiAdditionalTaxonSourceExport_OLD() {
		super();
	}
...
//		}
	...
	private static String getSourceDetail(Reference reference) {
		return PesiAdditionalTaxonSourceExport_OLD.citationMicroReference;
	}
	...
	public static void setCitationMicroReference(String citationMicroReference) {
		PesiAdditionalTaxonSourceExport_OLD.citationMicroReference = citationMicroReference;
	}
